...
- **Set up checkpoint** — alternative to protocol + forum for iterative projects. Create `.claude/checkpoint.md` with current state, blockers, decisions, and next steps. See `patterns/checkpoint.md`.
