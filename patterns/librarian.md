...
The librarian feedback loop (`patterns/feedback.md`) handles reactive processing of shutdown reflections in forum-based projects. But many projects need proactive maintenance without a forum. They need someone to go looking for problems, not wait for agents to report them.

## Solution

A librarian agent that proactively maintains project knowledge. This proactive variant is distinct from the reactive feedback loop in `patterns/feedback.md`:

| | Reactive (feedback.md) | Proactive (this pattern) |
|---|---|---|
...
- Projects without a forum where the librarian feedback loop doesn't apply

## When to Skip

- Steward-level projects (1 agent, minimal docs — the steward self-maintains)
- Projects already running the librarian feedback loop with an active forum that covers doc maintenance
...
- **Librarian feedback loop** (`patterns/feedback.md`) — in projects with both a forum and a playbook, one agent can serve both roles
...
| Project | Has librarian | Playbook maintained | Docs current |
|---------|--------------|--------------------:|--------------|
